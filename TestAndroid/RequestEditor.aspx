<%@ Page Title="" Language="C#" MasterPageFile="~/TestAndroid/MainMasterPage.Master" AutoEventWireup="true" CodeBehind="RequestEditor.aspx.cs" Inherits="BANURNS.TestAndroid.RequestEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content" >
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Редактор заявки</h4>
                        </div>
                        <div class="modal-body">
           <p>Принять изменения в заявке ?</p>
                            
                        </div>
                        <div class="modal-footer">
                         <button type="button" data-dismiss="modal" class="btn btn-primary mbtn" >Отмена</button>
                          <button type="button" data-dismiss="modal" id="SaveChangesButton" class="btn btn-success" >Да! Принять.</button>
                        </div>
      ...
      <button type="button"  data-toggle="modal"  data-target=".bs-example-modal-sm" id="SRB" class="btn btn-success St">Сохранить изменения</button>
             ...
             <%--       <p>Для загрузки шаблона укажите тип шаблона и дайте название шаблону.</p>--%>
                    ...
                    <textarea id="CommentText" style="width:100%; height:150px;"  maxlength="500" placeholder="Текст коментария"></textarea>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <input id="send" onclick="javascript: AddComment()" type="button" value="Ответить"  class="btn btn-success" />
                        </div>
                      </div>
                    </form>
