<%@ Page Title="" Language="C#" MasterPageFile="~/mhddisp/mhddisp.Master" AutoEventWireup="true" CodeBehind="ClosedRequests.aspx.cs" Inherits="BANURNS.mhddisp.ClosedRequests" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FotterPLaceHolder" runat="server">
    ...
    <script>
        ...
        $(".sr").click(function () {
            ...
            $.ajax({
                url: 'ClosedRequests.aspx/GetRequestContent',
                type: 'POST',
