<%@ Page Title="" Language="C#" MasterPageFile="~/sklad/Sklad.Master" AutoEventWireup="true" CodeBehind="DryWarehouses.aspx.cs" Inherits="BANURNS.sklad.DryWarehouses" %>
          ...
          <div class="clearfix"></div>
           <div class="row">
             ...
             <%--       <p>Для загрузки шаблона укажите тип шаблона и дайте название шаблону.</p>--%>
                   ...
                   <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Полок в ширину <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="CellInWidth"  value="1" class="form-control col-md-7 col-xs-12" min="1"  data-validate-length-range="1"  required="required" type="number"/>
                                ...
                                <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Полок в высоту <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
         ...
         <div class="clearfix"></div>
           ...
           <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                  <div class="x_title">
                    <h2>Описание складов <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Удаление скалада</h4>
                        </div>
                        <div class="modal-body">
                          <h4>Вы действительно хотите удалить?</h4>
                          <p>При удалении склада будет удалена вся информация связанная со складом.</p>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FotterPLaceHolder" runat="server">
    ...
    <script>
        ...
        function CreateNewDepot() {
            var SendData = {
                DepotName: $('#Name').val(), CellsInWidth: $('#CellInWidth').val(), CellsInHeight: $('#CellsInHeight').val()
            }

            $.ajax({
                url: 'DryWarehouses.aspx/CreateNewDepot',
                type: 'POST',
                ...
                success: function (data) {
                    if (data.d.IsDone == true) {
                        window.location.href = "DryWarehouses.aspx";
                    } else {
        ...
        function DeleteDepot()
        {
            ...
            SendtoServerDataStd("DryWarehouses.aspx/Remove", { ID: $(ClickedButton).attr("data-r") }, function (resp) {
