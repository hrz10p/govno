<%@ Page Title="" Language="C#" MasterPageFile="~/sklad/Sklad.Master" AutoEventWireup="true" CodeBehind="extradition.aspx.cs" Inherits="BANURNS.sklad.extradition" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FotterPLaceHolder" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {       
            ...
            $('.rep').click(function () {
                window.location.href = "CellsReport.aspx?rid=" + $(this).attr("data-r");
            });
            $('.cls').click(function () {
                
                data_r = $(this).attr('data-r');
        ...
        {
            var SendData = { RequestID: data_r, Comment: $('#CloseComment').val() };

            $.ajax({
                url: 'extradition.aspx/CloseRequest',
                type: 'POST',
                ...
                success: function (data) {
                    if (data.d.IsDone == true) {
                        ...
                        window.location.href = "extradition.aspx";
