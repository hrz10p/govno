<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="DepotAcces.aspx.cs" Inherits="BANURNS.AdminPanel.DepotAcces" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FotterPLaceHolder" runat="server">
    ...
    <script>
        ...
        function DeleteAcces()
        {
            ...
            $.ajax({
                url: 'DepotAcces.aspx/DeleteAcces',
                type: 'POST',
                ...
                success: function (data) {
                    if (data.d.IsDone == true) {
                        window.location.href = "DepotAcces.aspx";
                    } else {
        ...
        function CreateNewAccess()
        {
            ...
            $.ajax({
                url: 'DepotAcces.aspx/CreateAcces',
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                dataType: "JSON",
                data: JSON.stringify(SendData),
