<%@ Page Title="" Language="C#" MasterPageFile="~/sklad/Sklad.Master" AutoEventWireup="true" CodeBehind="deliveryB.aspx.cs" Inherits="BANURNS.sklad.deliveryB" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FotterPLaceHolder" runat="server">
    ...
    <script>
        function CloseRequest() {
            var SendData = {Message: $('#CloseComment').val() , RequestID: $('#RQID').attr('data-r') };

            $.ajax({
                url: 'deliveryB.aspx/PCloseRequest',
                type: 'POST',
